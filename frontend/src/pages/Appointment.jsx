...
const Appointment = () => {
  ...
  const formatTime = (date) => {
    ...
    const formattedHours = hours % 12 || 12; // 12시간제로 변환, 0시를 12시로 처리
    const formattedMinutes = minutes.toString().padStart(2, '0'); // 항상 2자리로 표현
  ...
  return docInfo && (
    <div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <div className='flex items-cetner gap-3 w-full overflow-x-scroll mt-4'>
          {
